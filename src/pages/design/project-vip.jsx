...
import { Crown, ListChecks, ArrowRight, LayoutGrid } from "lucide-react";
import { useState } from "react";

export default function ProjectVip() {
  const { t } = useTranslation();

  const [showPopup, setShowPopup] = useState(false);
  const [mobileSidebar, setMobileSidebar] = useState(false);

  const paragraphs = t("design.vip.text", { returnObjects: true }) || [];
  const listItems = t("design.vip.list", { returnObjects: true }) || [];
