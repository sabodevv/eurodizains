...
export default function Decoration() {
  ...
  const image = "/design/decoration/1.jpg";
  ...
  "
                ...
                {index === 0 && (
                  <motion.div
                    className="
                      ...
                      shadow-xl border-2 border-blue-100 cursor-pointer
                    "
                  ...
                  >
                    ...
                    {!isMobile && (
                      <>
                        <div className="absolute inset-0 bg-gradient-to-t from-[#3B82F6]/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition duration-500" />
      ...
      <AnimatePresence>
        {selectedImage && (
          ...
          >
            <motion.button
              className="absolute top-6 right-6 w-12 h-12 bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center text-white z-20"
