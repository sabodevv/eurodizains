...
import { UtensilsCrossed, ListChecks, ArrowRight } from "lucide-react";
      ...
      <div className="pt-28 flex relative overflow-hidden">
        ...
        <div className="flex-1 px-6 md:px-14 max-w-5xl mx-auto pb-24">
          ...
          >
            ...
            >
              <UtensilsCrossed className="w-4 h-4 text-[#3B82F6]" />
          ...
          {/* Includes */}
          <motion.div
            className="mt-12 p-8 bg-white/80 backdrop-blur-xl rounded-3xl border-2 border-cyan-100 shadow-xl"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <motion.button
              className="group relative px-10 py-5 bg-gradient-to-r from-[#3B82F6] to-[#38BDF8] rounded-full text-white font-bold text-lg shadow-xl hover:shadow-2xl transition-all inline-flex items-center gap-2"
              whileHover={{ scale: 1.05, y: -2 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => setIsPopupOpen(true)} // <-- открывает popup
            >
