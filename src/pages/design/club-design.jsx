      ...
      <div className="pt-28 flex relative overflow-hidden">
        ...
        <div className="flex-1 px-6 md:px-14 max-w-5xl mx-auto pb-24">
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-10">
            {[
              "/public/design/club/club1.jpg",
              "/public/design/club/club2.jpg",
            ].map((src, i) => (
              <motion.div
                key={i}
                whileHover={{ scale: 1.05 }}
                className="overflow-hidden rounded-3xl shadow-xl border-2 border-blue-100"
              >
                <img
                  src={src}
                  alt="Club design"
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() => setIsPopupOpen(true)} // <-- popup
            >
              {t("design.club.cta")}
