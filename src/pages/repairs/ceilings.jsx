...
export default function Ceilings() {
  ...
  const paragraphs = t("repairs.ceilings.text", { returnObjects: true });
  const listItems = t("repairs.ceilings.list", { returnObjects: true });
  ...
  return (
    <div className="pt-28 flex relative overflow-hidden">
      ...
      <div className="flex-1 px-6 md:px-14 max-w-5xl mx-auto pb-24">
        ...
        {/* Text sections with animation on desktop */}
        ...
        {!isMobile ? (
          ...
          <div className="mt-16 p-8 bg-white/80 backdrop-blur-xl rounded-3xl border-2 border-blue-100 shadow-xl">
            <h3 className="text-2xl font-bold text-gray-800 mb-6 flex items-center gap-3">
              <CheckCircle className="w-7 h-7 text-[#3B82F6]" />
              {t("repairs.ceilings.listTitle")}
            </h3>
        ...
        <div className="mt-12 text-center">
          <button
            ...
            onClick={() => setShowPopup(true)} // ✅ popup instead of scroll
          >
            <span className="relative z-10 flex items-center justify-center gap-2">
              {t("repairs.ceilings.cta")}
