...
export default function Vip() {
  ...
  const imagePositions = [0, 1, 3, 4];
  const listItems = t("repairs.vip.list", { returnObjects: true });
        ...
        <div className="flex-1 px-6 md:px-14 max-w-5xl mx-auto pb-20">
              ...
              >
                ...
                {imagePositions.includes(index) && (
                  <motion.div
                    ...
                    // Убираем эффекты при наведении для мобильных устройств
                  ...
                  >
                    <img
                      ...
                      // Для мобильной версии убираем эффекты при клике
                    />
                    {/* Убираем синий эффект и увеличение на мобильной версии */}
                    {isMobile ? null : (
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() => setShowPopup(true)} // ✅ popup
            >
