...
export default function Houses() {
  ...
  const paragraphs = t("repairs.houses.text", { returnObjects: true });
  const listItems = t("repairs.houses.list", { returnObjects: true });

  const images = [
    "/repairs/houses/1.jpg",
    "/repairs/houses/2.jpg",
    "/repairs/houses/3.jpg",
  ];
