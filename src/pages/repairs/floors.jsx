...
export default function Floors() {
  ...
  const paragraphs = t("repairs.floors.text", { returnObjects: true });
  const listItems = t("repairs.floors.list", { returnObjects: true });
      ...
      <div className="flex-1 px-6 md:px-14 max-w-5xl mx-auto pb-24 relative z-20">
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={() => setShowPopup(true)} // ✅ popup triggered
          >
            <span className="relative z-10 flex items-center justify-center gap-2">
              {t("repairs.floors.cta")}
