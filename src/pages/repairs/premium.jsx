...
export default function Premium() {
  ...
  const paragraphs = [
    ...
    t("repairs.premium.p2"),
    t("repairs.premium.p3"),
    t("repairs.premium.p4"),
    t("repairs.premium.p5"),
    t("repairs.premium.p6"),
  ];

  const images = [
    "/repairs/premium/1.jpg",
    "/repairs/premium/2.jpg",
    "/repairs/premium/3.jpg",
  ];
