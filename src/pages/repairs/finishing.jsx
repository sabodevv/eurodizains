...
import { Brush, CheckCircle, Layers, ArrowRight } from "lucide-react";
...
export default function Finishing() {
  ...
  const paragraphs = t("repairs.finishing.text", { returnObjects: true });
  const principles = t("repairs.finishing.principles", {
    returnObjects: true,
  });
  const advantages = t("repairs.finishing.advantages", {
    returnObjects: true,
  });
    ...
    <div className="pt-28 flex relative overflow-hidden">
      ...
      <div className="flex-1 px-6 md:px-14 max-w-5xl mx-auto pb-24">
        ...
        >
          ...
          >
            <Brush className="w-4 h-4 text-[#3B82F6]" />
            <span className="text-sm font-semibold text-[#3B82F6]">
              {t("repairs.finishing.intro")}
            </span>
          </motion.div>
        ...
        >
          <h3 className="text-2xl font-bold text-gray-800 mb-6 flex items-center gap-3">
            ...
            {t("repairs.finishing.principlesTitle")}
          </h3>
        ...
        >
          <h3 className="text-2xl font-bold text-gray-800 mb-6 flex items-center gap-3">
            ...
            {t("repairs.finishing.advantagesTitle")}
          </h3>
          <ul className="grid md:grid-cols-2 gap-3">
        ...
        >
          <p className="text-gray-600 mb-6">
            {t("repairs.finishing.contactText")}
          </p>
          <motion.button
